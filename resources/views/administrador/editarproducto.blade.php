...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Formulario de registro de producto') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ url('actualizar_producto')}}/{{$producto->id }}" enctype="multipart/form-data">
                        @csrf
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <img id="blah" src="/images/{{$producto->imagen}}" alt="tu producto" style="height:120px;width:120px;"/>
                                @error('nombre')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                         ...
                         <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Unidades') }}</label>

                            <div class="col-md-6">
                                <input id="unidades" type="number" class="form-control @error('unidades') is-invalid @enderror" name="unidades" value="{{$producto->unidades}}" required autocomplete="unidades" autofocus>
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                               <textarea rows=5 id="descripcion" type="text" class="form-control @error('InstruccionesActividad') is-invalid @enderror" name="descripcion"> {{$producto->descripcion}}</textarea> 
                            </div>
                        </div>

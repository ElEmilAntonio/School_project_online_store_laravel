 ...
 <div id="chart-div">
    ...
    <div class="container">
           @if($tipo==="1")<H1 >Todos</H1>
    @elseif($tipo==="2")<H1 >Pagados</H1>
    @else  <H1 >Pendientes</H1>
    @endif
        <div class="row justify-content-left">
           <div class="panel panel-default">
               <button type="submit" class="btn btn-primary" onclick="location.href='/pdf_venta/{{$tipo}}'" method="GET">
                        <i class="fa fa-btn fa-box"></i> Generar pdf ventas
                    </button>
 ...
 <?php $restante=$deuda->deuda_actual-$deuda->abono ?>
  ...
  @endif
                       <td>
                        <button type="submit" class="btn btn-primary btn-sm" onclick="location.href='/detalle_venta/{{$venta->id}}'" method="GET">
